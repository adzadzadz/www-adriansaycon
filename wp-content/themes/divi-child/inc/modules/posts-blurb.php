...
class ET_Builder_Module_Posts_Blurb extends ET_Builder_Module {
	function init() {
		$this->name             = esc_html__( 'TCM Posts Blurb', 'et_builder' );
		$this->plural           = esc_html__( 'TCM Posts Blurbs', 'et_builder' );
		$this->slug             = 'et_pb_tcm_posts_blurbs';
		$this->vb_support       = 'on';
